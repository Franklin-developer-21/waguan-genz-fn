...
function Chat() {
  ...
  const [callModalType, setCallModalType] = useState<"incoming" | "outgoing">(
    "outgoing"
  );
          ...
          {usersLoading ? (
            ...
            followedUsers.map((chat) => (
              <div
                ...
                className={`p-3 md:p-4 border-b border-gray-100 cursor-pointer ${
                  ...
                  <div>
                    ...
                    <p
                      className={`text-xs md:text-sm ${
                        selectedChat.online ? "text-blue-500" : "text-gray-500"
                      }`}
                    >
              ...
              {loading ? (
                ...
                <div className="flex items-center justify-center h-full">
                  <div className="text-center text-gray-500 p-4">
                    ...
                    <p className="text-sm md:text-base font-medium mb-1 md:mb-2">
                      No messages yet
                    </p>
